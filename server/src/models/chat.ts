...
// export function createDm(user1: UserId, user2: UserId){
//     const chat = {id: v4(), isDm: true}
//     const dmRecord = {id: chat.id, user1Id: user1, user2Id: user2}
//     const names = [
//         { chatId: chat.id, userId: user1, name: }
//     ]
